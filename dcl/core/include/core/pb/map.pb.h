...
class PBLocation final :
 ...
 public:
  ...
  ~PBLocation() override;
  explicit PROTOBUF_CONSTEXPR PBLocation(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PBLocation* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const PBLocation& from) {
    PBLocation::MergeImpl(*this, from);
  }
  private:
...
class PBBattleInfo final :
 ...
 public:
  ...
  ~PBBattleInfo() override;
  explicit PROTOBUF_CONSTEXPR PBBattleInfo(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PBBattleInfo* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const PBBattleInfo& from) {
    PBBattleInfo::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  PROTOBUF_NODISCARD ::PBPlayer* release_player_info();
  ...
  PROTOBUF_NODISCARD ::PBPlayer* release_enemey_info();
...
class PBGameState final :
 ...
 public:
  ...
  ~PBGameState() override;
  explicit PROTOBUF_CONSTEXPR PBGameState(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PBGameState* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const PBGameState& from) {
    PBGameState::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  PROTOBUF_NODISCARD ::PBBattleInfo* release_battle_info();
...
inline ::PBLocationID PBLocation::_internal_id() const {
  return static_cast< ::PBLocationID >(_impl_.id_);
}
...
inline int32_t PBLocation::_internal_database_id() const {
  return _impl_.database_id_;
}
inline int32_t PBLocation::database_id() const {
  // @@protoc_insertion_point(field_get:PBLocation.database_id)
  return _internal_database_id();
}
inline void PBLocation::_internal_set_database_id(int32_t value) {
  
  _impl_.database_id_ = value;
}
inline void PBLocation::set_database_id(int32_t value) {
...
void PBLocation::set_image(ArgT0&& arg0, ArgT... args) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void PBLocation::set_name(ArgT0&& arg0, ArgT... args) {
...
inline ::PBInteraction* PBLocation::add_interactions() {
  ::PBInteraction* _add = _internal_add_interactions();
...
inline const ::PBPlayer& PBBattleInfo::_internal_player_info() const {
  const ::PBPlayer* p = _impl_.player_info_;
...
inline ::PBPlayer* PBBattleInfo::release_player_info() {
  ...
  ::PBPlayer* temp = _impl_.player_info_;
...
inline ::PBPlayer* PBBattleInfo::mutable_player_info() {
  ::PBPlayer* _msg = _internal_mutable_player_info();
...
inline bool PBBattleInfo::_internal_has_enemey_info() const {
  return this != internal_default_instance() && _impl_.enemey_info_ != nullptr;
}
...
inline const ::PBPlayer& PBBattleInfo::_internal_enemey_info() const {
  const ::PBPlayer* p = _impl_.enemey_info_;
  return p != nullptr ? *p : reinterpret_cast<const ::PBPlayer&>(
      ::_PBPlayer_default_instance_);
}
...
inline void PBBattleInfo::unsafe_arena_set_allocated_enemey_info(
    ::PBPlayer* enemey_info) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.enemey_info_);
  }
  _impl_.enemey_info_ = enemey_info;
  if (enemey_info) {
...
inline ::PBPlayer* PBBattleInfo::release_enemey_info() {
  ...
  ::PBPlayer* temp = _impl_.enemey_info_;
...
inline ::PBPlayer* PBBattleInfo::_internal_mutable_enemey_info() {
  ...
  if (_impl_.enemey_info_ == nullptr) {
    auto* p = CreateMaybeMessage<::PBPlayer>(GetArenaForAllocation());
    _impl_.enemey_info_ = p;
  }
  return _impl_.enemey_info_;
}
inline ::PBPlayer* PBBattleInfo::mutable_enemey_info() {
  ::PBPlayer* _msg = _internal_mutable_enemey_info();
...
inline void PBBattleInfo::set_allocated_enemey_info(::PBPlayer* enemey_info) {
  ...
  if (enemey_info) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(
                reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(enemey_info));
    if (message_arena != submessage_arena) {
...
inline ::PBLocation* PBGameState::add_locations() {
  ::PBLocation* _add = _internal_add_locations();
...
inline bool PBGameState::_internal_has_battle_info() const {
  return this != internal_default_instance() && _impl_.battle_info_ != nullptr;
}
...
inline const ::PBBattleInfo& PBGameState::_internal_battle_info() const {
  const ::PBBattleInfo* p = _impl_.battle_info_;
...
inline void PBGameState::unsafe_arena_set_allocated_battle_info(
    ::PBBattleInfo* battle_info) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.battle_info_);
  }
  _impl_.battle_info_ = battle_info;
  if (battle_info) {
...
inline ::PBBattleInfo* PBGameState::release_battle_info() {
  ...
  ::PBBattleInfo* temp = _impl_.battle_info_;
  _impl_.battle_info_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::PBBattleInfo* PBGameState::_internal_mutable_battle_info() {
  ...
  if (_impl_.battle_info_ == nullptr) {
    auto* p = CreateMaybeMessage<::PBBattleInfo>(GetArenaForAllocation());
    _impl_.battle_info_ = p;
  }
  return _impl_.battle_info_;
}
inline ::PBBattleInfo* PBGameState::mutable_battle_info() {
  ::PBBattleInfo* _msg = _internal_mutable_battle_info();
...
inline void PBGameState::set_allocated_battle_info(::PBBattleInfo* battle_info) {
  ...
  if (battle_info) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(battle_info);
    if (message_arena != submessage_arena) {
