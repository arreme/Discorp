...
enum PBItemEnum : int {
  ...
  WOODEN_SWORD = 2000,
  WOODEN_HELMET = 3000,
  PBItemEnum_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  PBItemEnum_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
inline bool PBItemEnum_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, PBItemEnum* value) {
...
enum PBItemType : int {
  ...
  QUEST_ITEMS = 4,
  BUILDS = 5,
  PBItemType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  PBItemType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
inline bool PBItemType_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, PBItemType* value) {
...
class PBItemData final :
 ...
 public:
  ...
  ~PBItemData() override;
  explicit PROTOBUF_CONSTEXPR PBItemData(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PBItemData* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const PBItemData& from) {
    PBItemData::MergeImpl(*this, from);
  }
  private:
  ...
  int32_t sell_value() const;
  void set_sell_value(int32_t value);
  private:
  int32_t _internal_sell_value() const;
  void _internal_set_sell_value(int32_t value);
  public:
...
class PBItemsDict final :
 ...
 public:
  ...
  ~PBItemsDict() override;
  explicit PROTOBUF_CONSTEXPR PBItemsDict(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PBItemsDict* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const PBItemsDict& from) {
    PBItemsDict::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
void PBItemData::set_image_path(ArgT0&& arg0, ArgT... args) {
 
 _impl_.image_path_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void PBItemData::set_allocated_image_path(std::string* image_path) {
  ...
  _impl_.image_path_.SetAllocated(image_path, GetArenaForAllocation());
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void PBItemData::set_item_name(ArgT0&& arg0, ArgT... args) {
...
inline void PBItemData::clear_sell_value() {
  _impl_.sell_value_ = 0;
}
inline int32_t PBItemData::_internal_sell_value() const {
  return _impl_.sell_value_;
}
inline int32_t PBItemData::sell_value() const {
  // @@protoc_insertion_point(field_get:PBItemData.sell_value)
  return _internal_sell_value();
}
inline void PBItemData::_internal_set_sell_value(int32_t value) {
  
  _impl_.sell_value_ = value;
}
inline void PBItemData::set_sell_value(int32_t value) {
...
inline ::PBItemEnum PBItemData::_internal_item_id() const {
  return static_cast< ::PBItemEnum >(_impl_.item_id_);
}
...
inline int32_t PBItemData::_internal_quantity() const {
  return _impl_.quantity_;
}
inline int32_t PBItemData::quantity() const {
  // @@protoc_insertion_point(field_get:PBItemData.quantity)
  return _internal_quantity();
}
inline void PBItemData::_internal_set_quantity(int32_t value) {
  
  _impl_.quantity_ = value;
}
inline void PBItemData::set_quantity(int32_t value) {
...
inline ::PBItemType PBItemsDict::_internal_item_type() const {
  return static_cast< ::PBItemType >(_impl_.item_type_);
}
...
inline ::PBItemData* PBItemsDict::add_data() {
  ::PBItemData* _add = _internal_add_data();
